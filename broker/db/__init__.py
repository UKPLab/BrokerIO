...
def connect_db():
    ...
    :return: db instance
    """
    host = "http://{}:{}".format(os.getenv("ARANGODB_HOST", "localhost"), os.getenv("ARANGODB_PORT", "8529"))
    print("Connecting to {}".format(host))
    db_client = ArangoClient(hosts=host)
    ...
    sync_db = db_client.db(os.getenv("ARANGODB_DB_NAME", "broker"), username='root',
